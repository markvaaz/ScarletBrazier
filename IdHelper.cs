...
internal static class IdHelper {
  ...
  public static void RemoveId(this Entity entity) {
    if (!entity.Exists() || !entity.Has<UserMapZonePackedRevealElement>() || entity.Has<PlayerCharacter>()) return;

    entity.Remove<UserMapZonePackedRevealElement>();
  }
  ...
  public static bool IdStartsWith(this Entity entity, string prefix) {
    if (!entity.HasId()) return false;
    return entity.GetId().StartsWith(prefix);
  }
